...
export const AlephiumLogo: React.FC = () => (
  <svg
    width="100%"
    height="100%"
  ...
  >
    <g transform="matrix(1,0,0,1,-3372,0)">
      <g id="Plan-de-travail1" transform="matrix(0.714286,0,0,0.4876,2336.29,0)">
        <rect x="1450" y="0" width="1400" height="2050.86" fill="none"/>
